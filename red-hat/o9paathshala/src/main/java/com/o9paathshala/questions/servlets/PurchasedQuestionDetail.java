 ...
 */
@WebServlet("/PurchasedQuestionDetail")
public class PurchasedQuestionDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PurchasedQuestionDetail() {
        super();
        // TODO Auto-generated constructor stub
    }
    private static final Logger LOGGER = LoggerFactory.getLogger(PurchasedQuestionDetail.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			psList.add(psDTO);
			resultList=dao.getAll(SQLConstants.GET_PURCHASED_QUESTION_ON_ID.replace("instituteid",((SessionDTO)session.getAttribute("user")).getCurrentInstituteId().toString()),psList);
			if(null!=resultList){
