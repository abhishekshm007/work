...
public class AutoCompleteFaculty extends HttpServlet {
     ...
     */
    public AutoCompleteFaculty() {
        super();
        // TODO Auto-generated constructor stub
    }

    private static final Logger LOGGER = LoggerFactory.getLogger(AutoCompleteFaculty.class);
	/**
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		StringBuilder sql1 = new StringBuilder(SQLConstants.AUTO_COMPLETE_FACULTY);
		String jsonString =null;
		Gson gson = new Gson();
		try {
		if(request.getParameter("tagName") != null) {
			String search=request.getParameter("tagName");
			sql1.append(" like '"+search+"%' order by faculty_name asc limit 5");
		}
