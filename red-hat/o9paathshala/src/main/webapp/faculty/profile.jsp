	...
	<div class="col-md-12  toppad">
		...
		<div class="box box-primary" id="box1">
			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-2">
						<a data-toggle="modal" class="fakeLink" title="click to change"
							data-target="#editdp" id="dp"> <img
						...
						<table class="table table-user-information table-responsive">
							<tbody>
								...
								<tr>
									...
									<td>********</td>
									<td><a data-toggle="modal" class="fakeLink"
										data-target="#editpassword">Edit</a></td>
								</tr>
							</tbody>
						</table>
					</div>
		...
		<div class="modal-content" id="box">
			...
			<form id="userProfileForm">
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="Gender">Gender</label> <select id="g" name="gender"
							class="form-control input-md">
					...
					<div class="form-group">
						<label for="dob">Date of birth</label> <input id="d" name="dob"
	...
	<div id="myModal1" class="modal-dialog modal-lg">
		<div class="modal-content" id="box">
			<div class="modal-header" id="modalheader">
				<button type="button" class="close" data-dismiss="modal"
					aria-hidden="true" onclick="clear()">×</button>
				<h3 class="modal-title" class="label label-success">Enter new
					Password</h3>
			</div>
			...
			<form id="passwordForm" method="post">
				<div class="modal-body">
					<div class="form-group">
						<input name="p" required minlength="6" type="password"
	...
	<div id="myModal1" class="modal-dialog modal-lg">
		<div class="modal-content" id="box5">
			<div class="modal-header" id="modalheader">
				<button type="button" class="close" data-dismiss="modal"
					aria-hidden="true" onclick="clear()">×</button>
				<h3 class="modal-title" class="label label-success">New profile
					picture</h3>
			</div>
			<form enctype="multipart/form-data"
				onsubmit="uploadDp(this,'../UploadDp')" id="dpForm" method="post">
				<div class="modal-body">
					<div class="form-group">
						<input name="dp" required accept=".png,.jpg,.jpeg" type="file"
							placeholder="New dp" class="form-control input-md"> <span
							class="help-block"> Note:- Only jpg,png or jpeg format is
							alowed.</span>
					</div>
				</div>
				<div class="modal-footer">
